...
public class Main_LinearRegression {
    ...
    private final static OutcomeCorrelationReport<StructType, Dataset<Row>> mpgCorrelationReport = new SystemPrintCorrelationMPGReport();
    ...
    public static void main(String... args) {
        ...
        mpgCorrelationReport.apply(autoSchema, autoCleansed);
